...
const filha1 = Object.create(pai) // tem como prototipo o pai
filha1.nome = 'Ana'
...
for(let key in filha2) {
    ...
    console.log(key) : console.log(`Por herança: ${key}`) // nome (que é chave dela hasOwnProperty) Por herança: corCabelo (herdou do pai)
}